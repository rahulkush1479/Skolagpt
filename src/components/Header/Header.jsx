...
export default function Header() {
    return (
        <div className="absolute top-0 right-0 m-4 flex flex-col items-end gap-6">
            <div className="cursor-pointer group flex items-center justify-center rounded-full  w-12 h-12 transition-all duration-300 ease-in-out hover:w-32 hover:scale-105 hover:shadow-xl bg-yellow-500 ">
            ...
            <div className="cursor-pointer group flex items-center justify-center rounded-full  w-12 h-12 transition-all duration-300 ease-in-out hover:w-32 hover:scale-105 hover:shadow-xl bg-red-500 ">
